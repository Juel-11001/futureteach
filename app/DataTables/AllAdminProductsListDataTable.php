...
use App\Models\AllAdminProductsList;
...
class AllAdminProductsListDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('approve', function($query){
                ...
                return $query->is_approved == 1
            ? '<span class="badge badge-success">Approved</span>'
            : '<span class="badge badge-warning">Pending</span>';
              }
            })
            ->rawColumns(['image', 'type', 'status', 'action', 'created by', 'approve'])
            ->setRowId('id');
    }
    ...
    {
        return $model->where('admin_id','!=',  Auth::user()->id)->where('is_approved', '1')->with('user')->newQuery();
    }
    ...
    {
        return $this->builder()
            ->setTableId('alladminproductslist-table')
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('created by')->width(80),
    ...
    {
        return 'AllAdminProductsList_' . date('YmdHis');
    }
}
