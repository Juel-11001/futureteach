...
use App\Models\AllAdminProductsPending;
...
class AllAdminProductsPendingDataTable extends DataTable
{
    /**
    ...
    {
        return $this->builder()
            ->setTableId('alladminproductspending-table')
    ...
    {
        return 'AllAdminProductsPending_' . date('YmdHis');
    }
}
